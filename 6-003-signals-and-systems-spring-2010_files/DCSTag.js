...
var benchmarkTracker = _gat._getTracker("UA-5145472-1");
benchmarkTracker._setDomainName('mit.edu');
benchmarkTracker._initData();
benchmarkTracker._trackPageview();

var overallTracker = _gat._getTracker("UA-5033010-1");
overallTracker._setDomainName('mit.edu');
overallTracker._initData();
overallTracker._trackPageview();

var QATracker = _gat._getTracker("UA-3208508-1");
QATracker._setDomainName('ocw3.mit.edu');
QATracker._initData();
QATracker._trackPageview();
...
function trackDocuments (evnt) { 
  ...
  if (typeof(QATracker) == "object") {
	  QATracker._trackPageview(url);
  }
}
